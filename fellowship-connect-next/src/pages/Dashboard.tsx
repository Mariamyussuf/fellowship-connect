      ...
      <div className="dashboard">
        ...
        <div className="stats-container">
          ...
          <div className="stat-card">
            ...
            <Link href="/prayer-requests">View Requests</Link>
          </div>
        </div>
        ...
        <div className="quick-actions">
          ...
          <div className="action-buttons">
            <Link href="/attendance" className="action-button">
              Check In
            </Link>
            <Link href="/prayer-requests/new" className="action-button">
              Submit Prayer Request
            </Link>
            <Link href="/testimonies/new" className="action-button">
              Share Testimony
            </Link>
        ...
        <div className="dashboard-section">
          <div className="section-header">
            <h2>Announcements</h2>
            {isAdmin && (
              <Link href="/announcements/new" className="btn-small">
                New Announcement
              </Link>
            )}
          </div>
          ...
          <div className="events-list">
            {upcomingEvents.length > 0 ? (
              upcomingEvents.map((event) => (
                <Link href={`/events/${event.id}`} key={event.id} className="event-item">
                  <h3>{event.title}</h3>
                  <p>
