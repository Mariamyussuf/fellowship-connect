...
import type { FellowshipUser, PrayerRequest, WelfareRequest, EvangelismReport, AttendanceRecord } from '../types';
...
const AdminDashboard: React.FC = () => {
  ...
  const [systemStats, setSystemStats] = useState<{
    ...
    attendance: {
      total: number;
      recentTotal: number;
      uniqueRecentAttendees: number;
      averageWeekly: number;
    };
    engagement: {
      prayerRequests: number;
      welfareRequests: number;
      evangelismReports: number;
    };
  } | null>(null);
